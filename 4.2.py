...
garden = [11, 92, 1, 42, 15, 12, 11, 81]

bush = 1

if bush == 1:
    res = garden[0] + garden[1] + garden[-1]
elif bush == len(garden):
    res = garden[-2] + garden[-1] + garden[0]
else:
    res = garden[bush-1] + garden[bush-2] + garden[bush]
print(f'Макс. кол-во ягод {res}, собрано для куста {bush}')